...
<div class="lg:h-screen bg-rock relative">
  ...
  <!-- <HeaderWave newClass="absolute bottom-0 w-full inset-x-0" /> -->
  <svg class="absolute bottom-0 w-full inset-x-0" fill="#8013BD" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" viewBox="0 0 1440 150">
