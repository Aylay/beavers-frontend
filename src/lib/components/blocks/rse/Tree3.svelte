...
on:inview_change={handleChange}>
	<div class="relative flex flex-1 justify-center gap-8"  use:inview={optionsImg} on:inview_change={handleChangeImg}>
		<div class="flex flex-1 flex-col gap-8 ">
			<div class="flex-3 relative">
				{#if isInViewImg}
					<picture>
						<source srcset="/img/rse/tree-nation-2.webp" type="image/webp">
						<source srcset="/img/rse/tree-nation-2.jpg" type="image/jpeg">
						<img
							src="/img/rse/tree-nation-2.jpg"
							alt="Tree-Nation"
			...
			<div class="flex-2 relative">
				{#if isInViewImg}
					<picture>
						<source srcset="/img/rse/tree-nation-3.webp" type="image/webp">
						<source srcset="/img/rse/tree-nation-3.jpg" type="image/jpeg">
						<img
							src="/img/rse/tree-nation-3.jpg"
							alt="Tree-Nation"
							class="h-full w-full object-cover overflow-hidden rounded-lg {isInViewImg ? 'animate-fade' : 'opacity-0'}"
						/>
					</picture>
		...
		<div class="relative flex flex-1 items-center">
			<div class="w-full lg:h-1/2 relative">
				{#if isInViewImg}
					<picture>
						<source srcset="/img/rse/tree-nation-4.webp" type="image/webp">
						<source srcset="/img/rse/tree-nation-4.jpg" type="image/jpeg">
						<img
							src="/img/rse/tree-nation-4.jpg"
							alt="Tree-Nation"
							class="h-full w-full object-cover overflow-hidden rounded-lg {isInViewImg ? 'animate-fade' : 'opacity-0'}"
						/>
					</picture>
  ...
  <div class="lg:flex-1">
    ...
    <div class="mt-20 animate-delay-1000 {isInView
      ? 'animate-fade'
      : 'opacity-0'}">
      <Cta label="Tree-Nation" href="https://tree-nation.com/fr/profil/impact/beavers" type="transparent" blank={true} />
    </div>
  </div>
</div>
