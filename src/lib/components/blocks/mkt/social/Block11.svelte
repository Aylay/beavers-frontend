...
on:inview_change={handleChange}>
  <div class="lg:flex-1">
		<Line />
		<Title first="Les social ads, comment ça marche&nbsp;?" />
		<h3
		...
		>
			<p class="text-6 animate-delay-500 {isInView
				? 'animate-fade'
				: 'opacity-0'}">
				Les différentes plateformes sociales mettent à disposition des outils d'achat d'espace. L'avantage avec les social ads c'est, qu'en général, les <strong>outils de publicité</strong> sont accessibles à tous. Globalement, avec la rédaction d'un texte, quelques visuels et une carte bancaire, n'importe qui peut lancer sa campagne.
			</p>
			<p class="text-6 animate-delay-500 {isInView
				? 'animate-fade'
				: 'opacity-0'}">
