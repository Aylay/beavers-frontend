...
<div class="relative flex lg:flex-1 flex-col gap-28">
	...
	<div class="lg:flex-1">
		...
		>
			...
			<p class="text-6">
				Chaque cas est différent et notre <a href="/l-agence-beavers/agence-social-ads" title="Agence Social Ads Beavers" class="font-bold underline text-electric hover:text-bright transition-colors">agence social ads</a> étudie l'annonceur et son besoin afin de déterminer <strong>quelle stratégie mettre en place</strong>.
			</p>
		</div>
