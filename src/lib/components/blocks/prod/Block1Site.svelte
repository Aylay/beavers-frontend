...
>
	<div class="flex-1 max-lg:order-2">
		...
		>
			<p class="text-6">
				Dans le monde d'aujourd'hui, il est indispensable d'être présent en ligne pour montrer tout de suite à vos clients / prospects qui vous êtes et ce que vous faites.
			</p>
			<p class="text-6">
				De la TPE aux grandes entreprises, un site vitrine peut suffire pour se montrer et être contacté.
			</p>
			<p class="text-6">
				L'agence Beavers analyse vos besoins et vous propose un site vitrine sur mesure optimisé en <a href="/la-pause-cafe/seo/definition-seo-search-engine-optimization" title="Définitiion du SEO" class="font-bold underline hover:no-underline text-seance">SEO</a> avec un back-office s'il y a un besoin d'administration. Dans tous les cas, le site vitrine sera responsive, c'est-à-dire qu'il s'adaptera à tout type d'écran : ordinateur, tablette, téléphone et même télévision.
			</p>
		</div>
