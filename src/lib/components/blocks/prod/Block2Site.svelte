  ...
  <div class="lg:flex-1">
		...
		>
			...
			<p class="text-6 animate-delay-500 {isInView
				? 'animate-fade'
				: 'opacity-0'}">
				L'agence Beavers vous propose la création et le développement d'un blog sur mesure avec la technologie <a href="https://svelte.dev/" title="Svelte" target="_blank" class="font-bold underline text-electric">Svelte</a> additionnée au <a href="https://strapi.io/" title="Strapi" target="_blank" class="font-bold underline text-electric hover:text-bright transition-colors">CMS Strapi</a> pour un gain de performances afin que le site s'affiche rapidement et qu'il y ait que très peu de chargement de page.
			</p>
