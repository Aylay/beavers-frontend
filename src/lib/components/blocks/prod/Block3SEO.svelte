...
>
  <div class="lg:flex-1">
    <Line />
    <Title first="Optimisations<br />& conseils du contenu" />
		<h3
      ...
      Le maître-mot des mots clés
		...
		>
      <p class="text-6">
        Afin d'avoir un bon <a href="/la-pause-cafe/seo/" title="Articles SEO" class="font-bold underline hover:no-underline text-seance">SEO</a> sur votre site internet, il est important de déterminer les mots-clés sur lesquels il faut se positionner.
      </p>
      <p class="text-6">
  ...
  <div class="lg:flex-1">
    <Line />
    <Title first="Créer & optimiser<br />le maillage" />
		<h3
			class="mt-2 font-highlight text-4 text-bright lg:animate-delay-200 {isInView
				? 'lg:animate-fade-right'
				: 'lg:opacity-0'}"
