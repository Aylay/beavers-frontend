...
>
  <div class="lg:flex-1">
    ...
    <p class="text-6 mb-8 animate-delay-500 {isInView
      ? 'animate-fade'
      : 'opacity-0'}">
      Nous aussi, chez Beavers, nous aimons en recevoir (mais pas trop, juste celles qui nous intéressent, il faut faire attention à la nature) mais aussi en envoyer.
    </p>
    <p class="text-6 mb-8 animate-delay-500 {isInView
      ? 'animate-fade'
      : 'opacity-0'}">
      La newsletter est un outil de communication simple et qui plait à tous. Simplicité d'inscription et de désinscription pour avoir l'information qu'il faut. Mais attention, il n'est pas si simple de bien designer et de bien coder une newsletter. Beaucoup de choses sont interdites et d'autres vivement conseillées.
    </p>
