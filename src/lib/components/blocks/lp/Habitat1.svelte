...
>
	<div class="flex-1">
		...
		>
			<p class="text-6">
				Visibilité, drive to strore, génération de leads, vente, recrutement de franchisés, visites sur le site, etc.
			</p>
			<p class="text-6">
				Pour chacun de vos objectifs, nous activons une stratégie digitale personnalisée afin de booster vos performances.
			</p>
			<p class="text-6">
				Nous analysons votre entreprise, vos concurrents, et votre public cible pour concevoir une stratégie digitale sur mesure
			</p>
		</div>
