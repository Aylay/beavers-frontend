...
export const load = (async ({ fetch, params }) => {
	const useCaseResponse = await fetch(import.meta.env.VITE_STRAPI_URL + '/api/use-cases/' + params.slug + '?populate[meta][fields][0]=title&populate[meta][fields][1]=description&populate[meta][populate][ogImage][fields][0]=url&populate[meta][populate][ogImage][fields][1]=width&populate[meta][populate][ogImage][fields][2]=height&populate[categories][fields][0]=title&populate[0]=contract&populate[client][fields][0]=name&populate[client][fields][1]=description&populate[client][populate][useCases][fields][0]=slug&populate[client][populate][useCases][fields][1]=title&populate[client][populate][logo][fields][0]=url&populate[client][populate][logo][fields][1]=alternativeText&populate[mainImg][fields][0]=formats&populate[mainImg][fields][1]=url&populate[mainImg][fields][2]=alternativeText&populate[img1][fields][0]=formats&populate[img1][fields][1]=url&populate[img1][fields][2]=alternativeText&populate[img2][fields][0]=formats&populate[img2][fields][1]=url&populate[img2][fields][2]=alternativeText&populate[goals][fields][0]=text&populate[results][fields][0]=text1&populate[results][fields][1]=text2', {
		method: 'GET'
	})
